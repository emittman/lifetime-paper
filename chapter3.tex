...
\centering
   ...
   \includegraphics[width=.8\textwidth]{b10new.pdf}
%    \caption{Point estimate and 50\% CI for $t_{0.10}$}
% \end{subfigure}

   \includegraphics[width=.8\textwidth]{pinew.pdf}
   % \caption{Top: Point estimate and 50\% CI for $t_{0.10}$. Bottom: Point estimate and 50\% CI for $\pi$}

\caption{Top: 50\% CI (in years) for $t_{0.10}$. Bottom: 50\% CI for $\pi$ plotted on the logit scale.  Both plots are sorted based on the median value of $t_{0.10}$.}
\label{fig:Ng2}
